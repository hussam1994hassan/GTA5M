        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <input
                        ...
                        className="bg-gray-800 w-full h-10 rounded-md border border-gray-200 py-2 px-4 box-border"
                        name="biling_to"
                        id="biling_to"
            ...
            <div className="w-full h-auto flex flex-col gap-6">
                ...
                <div className="w-full h-auto min-h-32 grid grid-cols-1 xl:grid-cols-4 md:grid-cols-2 gap-5">
                    <div className="bg-gray-900 w-full h-auto rounded-2xl shadow flex flex-col gap-2 justify-center items-start p-5 box-border">
                ...
                <div className="bg-blue-950 w-full h-auto p-7 box-border border-2 border-blue-400 border-dotted rounded-xl flex flex-row items-start justify-center gap-5">
                ...
                <div className="bg-gray-900 w-full h-auto rounded-2xl shadow flex flex-col">
                    <div className="w-full h-auto hidden md:grid grid-cols-12 gap-5 items-center border-b-2 border-gray-500 p-7 box-border">
                    ...
                    <div className="w-full h-auto flex flex-col gap-5 mb-4">
                        {payments.length > 0 ? (
                            payments.map((payment, index) => (
                                <div
                                    key={index}
                                    className="w-full h-auto grid md:grid-cols-12 grid-cols-5 gap-5 p-7 box-border border-b-2 border-gray-500 border-dotted"
                                >
                                    <span className="text-gray-400 text-sm font-medium uppercase col-span-1">
                                        #{payment.id}
                                    </span>
                                    ...
                                    <div className="col-span-2">
                                        {payment.status == 0 ? (
                                            <small className="bg-orange-500/10 text-orange-500 max-w-max px-4 py-1 text-xs rounded-xl">
                                                Pending
                                            </small>
                                        ) : payment.status == 1 ? (
                                            <small className="bg-green-500/10 text-green-500 max-w-max px-4 py-1 text-xs rounded-xl">
                                                Approved
                                            </small>
                                        ) : (
                                            <small className="bg-red-500/10 text-red-500 max-w-max px-4 py-1 text-xs rounded-xl">
                                                Declined
                                            </small>
                                        )}
                                    </div>
