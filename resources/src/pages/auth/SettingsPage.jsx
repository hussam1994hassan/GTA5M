    ...
    return (
        <div className="w-full h-auto flex flex-col gap-10">
            ...
            <div className="bg-gray-900 w-full h-auto rounded-2xl shadow flex flex-col">
                <div className="w-full h-auto flex flex-row items-center justify-start border-b-2 border-gray-400 p-7 box-border">
                    ...
                    <div className="w-full h-auto flex flex-row items-center justify-between gap-5">
                        <div className="w-full h-auto flex flex-col gap-1">
                            <div className="w-full h-10 flex flex-col gap-1 rounded-md border border-gray-200 relative">
                                <span className="text-gray-200 bg-gray-800 px-2 py-1 max-w-max text-xs capitalize absolute -top-3 left-2">
                                    First Name
                                </span>
                                <input
                                    type="text"
                                    className="bg-transparent w-full h-full text-gray-100 outline-none py-2 px-4 box-border absolute top-0 left-0"
                                    name="first_name"
                                    id="first_name"
            ...
            <form
                ...
                className="bg-gray-900 w-full h-auto rounded-2xl shadow flex flex-col"
            >
                <div className="w-full h-auto flex flex-row items-center justify-start border-b-2 border-gray-400 p-7 box-border">
                    <span className="text-gray-400 text-sm font-medium uppercase flex flex-row items-center gap-2">
