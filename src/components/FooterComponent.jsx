    ...
    <footer className="bg-gray-800 border-t border-cyan-500/30 py-20 relative overflow-hidden">
        ...
        <div className="grid grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400 font-mono">
              <li>
                <a href="#" className="hover:text-emerald-400 transition-colors hover:translate-x-2 transform duration-200 inline-block">
                  &gt; Security_Protocol
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400 font-mono">
              <li>
                <a href="#" className="hover:text-cyan-400 transition-colors hover:translate-x-2 transform duration-200 inline-block">
                  &gt; Vault_Support
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400 font-mono">
              <li>
                <a href="#" className="hover:text-yellow-400 transition-colors hover:translate-x-2 transform duration-200 inline-block">
                  &gt; Security_Policy
                </a>
              </li>
              <li>
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-20">
        ...
        {[...Array(6)].map((_, i) => (
          <div 
            key={i}
            className={`absolute text-${i % 3 === 0 ? 'emerald' : i % 3 === 1 ? 'cyan' : 'yellow'}-400/30`}
            style={{
              left: `${10 + i * 15}%`,
