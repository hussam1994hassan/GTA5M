          ...
          <div className="flex items-center space-x-6 group cursor-pointer">
            ...
            <div className="flex flex-col relative">
              ...
              <div className="relative overflow-hidden">
                ...
                {/* Animated Underline */}
                <div className="absolute bottom-0 left-0 h-1 bg-gradient-to-r from-emerald-400 via-cyan-400 to-yellow-400 opacity-0 group-hover:opacity-100 transition-all duration-500 expand-width"></div>
              </div>
            ...
            <div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-500">
              {[...Array(8)].map((_, i) => (
                <div 
                  key={i}
                  className={`absolute w-1 h-1 rounded-full particle-orbit ${i % 4 === 0 ? 'bg-emerald-400' : i % 4 === 1 ? 'bg-cyan-400' : i % 4 === 2 ? 'bg-blue-400' : 'bg-yellow-400'}`}
                  style={{
      ...
      {isMenuOpen && (
        <div className="lg:hidden bg-black/95 backdrop-blur-xl border-t border-gray-800">
          <div className="max-w-7xl mx-auto px-8 py-6 space-y-4">
            <a href="#vault" className="block text-gray-300 hover:text-emerald-400 transition-colors py-2 text-lg font-mono">
              [VAULT_CORE]
            </a>
            <a href="#security" className="block text-gray-300 hover:text-cyan-400 transition-colors py-2 text-lg font-mono">
              [SECURITY]
            </a>
            <a href="#marketplace" className="block text-gray-300 hover:text-yellow-400 transition-colors py-2 text-lg font-mono">
              [MARKETPLACE]
            </a>
            <a href="#integration" className="block text-gray-300 hover:text-blue-400 transition-colors py-2 text-lg font-mono">
              [INTEGRATION]
            </a>
