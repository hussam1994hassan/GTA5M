...
const DashboardPage = () => {
    ...
    const sidebarItems = [
        { id: "overview", label: "Dashboard", icon: <Home className="w-5 h-5" />, badge: null },
        { id: "store-settings", label: "Store Settings", icon: <Store className="w-5 h-5" />, badge: null },
        { id: "products", label: "Products", icon: <Boxes className="w-5 h-5" />, badge: 25 },
        { id: "add-product", label: "Add Product", icon: <Plus className="w-5 h-5" />, badge: null },
        { id: "orders", label: "Orders", icon: <Receipt className="w-5 h-5" />, badge: serverData.orders.pending },
        { id: "customers", label: "Customers", icon: <Users className="w-5 h-5" />, badge: serverData.customers.new },
        { id: "analytics", label: "Analytics", icon: <PieChart className="w-5 h-5" />, badge: null },
        { id: "reports", label: "Reports", icon: <FileBarChart className="w-5 h-5" />, badge: null },
        { id: "api", label: "API & Webhooks", icon: <Code className="w-5 h-5" />, badge: null },
        { id: "security", label: "Security", icon: <Shield className="w-5 h-5" />, badge: null },
        { id: "notifications", label: "Notifications", icon: <BellRing className="w-5 h-5" />, badge: 3 },
        { id: "settings", label: "Settings", icon: <Cog className="w-5 h-5" />, badge: null }
    ];
    ...
    const renderContent = () => {
        switch (activeTab) {
            ...
            case "add-product":
                return <AddProductPage onProductAdded={() => setActiveTab("products")} />;
            case "edit-product":
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white flex">
                        ...
                        {!sidebarCollapsed && (
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-emerald-400 font-mono text-sm">SERVER_DASHBOARD</p>
                                </div>
                            </div>
                        )}
                        <button 
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center gap-3 p-3 bg-gray-700/30 rounded-xl">
                                ...
                                <div className="flex-1">
                                    <div className="text-white font-semibold">admin_user</div>
                                    <div className="text-gray-400 text-xs font-mono">Premium Plan</div>
                                </div>
                            </div>
                            <button className="w-full flex items-center gap-3 px-4 py-2 text-gray-400 hover:text-red-400 transition-colors font-mono">
            ...
            <div className="flex-1 relative z-10">
                ...
                <div className="bg-gray-800/60 backdrop-blur-xl border-b border-gray-700 px-8 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            {/* Server Status */}
                            <div className="flex items-center gap-2 bg-emerald-500/20 border border-emerald-400/30 px-3 py-2 rounded-lg">
                ...
                {/* Page Content */}
                <main className="p-8 overflow-y-auto" style={{ height: 'calc(100vh - 80px)' }}>
                        ...
                        <div className="space-y-4">
                            <div className="bg-emerald-500/20 border border-emerald-400/30 p-4 rounded-xl">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h4 className="text-emerald-400 font-bold font-mono text-sm">New Sale</h4>
                                        <p className="text-gray-300 text-sm">john_doe purchased Legendary Weapon Pack for $49.99</p>
                                        <p className="text-gray-500 text-xs font-mono mt-1">2 minutes ago</p>
                                    </div>
                                </div>
                            </div>
                        </div>
