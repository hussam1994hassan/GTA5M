...
const IndexPage = () => {
    ...
    useEffect(() => {
        const handleScroll = () => setScrollY(scrollY);
    ...
    const features = [
        {
            ...
            description:
                "Advanced blockchain-inspired security that holds transactions in a protected quantum state until delivery confirmation.",
        ...
        },
        {
            ...
            description:
                "AI-powered instant delivery system that learns and adapts to optimize transaction speed and reliability.",
        ...
        },
        {
            ...
            description:
                "Futuristic admin dashboard with real-time analytics, holographic data visualization, and predictive insights.",
        ...
        },
        {
            ...
            description:
                "Seamless API integration with advanced webhooks, custom scripts, and automated server management tools.",
        ...
        },
        {
            ...
            description:
                "Support for cryptocurrency, traditional banking, gaming tokens, and future payment technologies.",
        ...
        },
        {
            ...
            description:
                "Military-grade encryption with biometric verification, quantum-resistant algorithms, and zero-trust architecture.",
    ...
    const stats = [
        {
            ...
            subtext: "Connected to the Matrix",
    ...
    return (
        <div className="min-h-screen text-white overflow-x-hidden relative">
          ...
          `,
                ...
                ></div>
                <div
                    className="absolute top-1/2 left-3/4 w-64 h-64 bg-yellow-500/10 rounded-full blur-3xl animate-pulse"
                ...
                <div
                    className="absolute top-0 right-1/3 w-px h-full bg-gradient-to-b from-transparent via-purple-500/30 to-transparent animate-pulse"
                    style={{ animationDelay: "1s" }}
                ></div>
                <div
                    className="absolute top-0 left-2/3 w-px h-full bg-gradient-to-b from-transparent via-yellow-500/30 to-transparent animate-pulse"
                    style={{ animationDelay: "2s" }}
                ></div>
            </div>
                ...
                <div className="relative max-w-7xl mx-auto px-8 text-center">
                    ...
                    <div className="mb-16">
                        ...
                        <div className="relative mb-8">
                            <h1 className="text-8xl font-black mb-4 leading-tight tracking-tight font-mono">
                                <span className="relative inline-block">
                                    ...
                                    <span
                                        className="absolute inset-0 text-cyan-400 opacity-75 animate-pulse"
                                ...
                                <span className="block mt-4 relative">
                                    ...
                                    <span
                                        className="absolute inset-0 bg-gradient-to-r from-purple-400 via-cyan-400 to-yellow-400 bg-clip-text text-transparent opacity-50 animate-pulse"
                        ...
                        <p className="text-2xl text-gray-300 mb-12 max-w-5xl mx-auto leading-relaxed font-medium">
                            ...
                            through quantum-secured transactions.
                        ...
                        {stats.map((stat, index) => (
                            ...
                            >
                                ...
                                <div className="relative">
                                    ...
                                    <div
                                        className={`text-4xl font-black font-mono text-${stat.color}-400 mb-2 group-hover:scale-110 transition-transform`}
                                    >
                                        {stat.number}
                                    </div>
                ...
                <div className="max-w-7xl mx-auto px-8 relative">
                    <div className="text-center mb-20">
                        ...
                        <p className="text-2xl text-gray-300 font-mono">
                            &gt; Advanced features for the digital frontier
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-8">
                        {features.map((feature, index) => (
                            <div
                                key={index}
                                className={`group relative bg-gradient-to-br from-gray-800/60 to-gray-900/60 p-10 rounded-3xl border border-gray-700 hover:border-${feature.glow}-400/50 transition-all duration-500 backdrop-blur-sm overflow-hidden`}
                            >
                                {/* Holographic Effect */}
                                <div
                                    className={`absolute inset-0 bg-gradient-to-br from-${feature.glow}-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                                ></div>
                                <div
                                    className="absolute inset-0 opacity-0 group-hover:opacity-30 transition-opacity duration-500"
                                    style={{
                                        background: `linear-gradient(45deg, transparent, rgba(${
                                            feature.glow === "cyan"
                                                ? "6, 182, 212"
                                                : feature.glow === "yellow"
                                                ? "245, 158, 11"
                                        ...
                                        animation:
                                            "hologram 3s linear infinite",
                                    }}
                                ></div>

                                <div className="relative">
                                    <div
                                        className={`inline-flex p-6 rounded-2xl bg-gradient-to-r ${feature.color} mb-8 group-hover:scale-125 transition-transform duration-500 shadow-lg relative overflow-hidden`}
                                    >
                                        <div className="text-white relative">
                                            {feature.icon}
                                        </div>
                                        <div
                                            className={`absolute inset-0 bg-${feature.glow}-400/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur`}
                                        ></div>
                                    </div>
                                    <h3
                                        className={`text-2xl font-bold font-mono mb-6 text-white group-hover:text-${feature.glow}-400 transition-colors`}
                                    >
                                        [
                                        {feature.title
                                            .toUpperCase()
            ...
            <section className="py-24 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-8 relative">
                    <div className="text-center mb-20">
                        ...
                        <p className="text-2xl text-gray-300 font-mono">
                            &gt; Mission control for server operators
                        </p>
                    </div>
                    ...
                    <div className="flex justify-center mb-12">
                        <div className="flex bg-gray-800/80 rounded-2xl p-2 border border-gray-700 backdrop-blur-sm">
                            {["servers", "analytics", "transactions"].map(
                                (tab) => (
                                    <button
                                        key={tab}
                        ...
                        <div className="relative">
                            ...
                            <div className="text-center">
                                <p className="text-xl text-gray-300 font-mono mb-8">
                                    ...
                                    monitoring, automated deployment protocols
                                </p>
