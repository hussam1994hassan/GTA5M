        ...
        <div className="max-w-7xl mx-auto px-8 relative z-10">
          <div className="text-center mb-20">
            <h2 className="text-5xl font-black mb-8 text-white">
              Your <span className="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">Complete</span> Vault Solution
            </h2>
            <p className="text-2xl text-gray-300 max-w-4xl mx-auto">
              We provide everything you need to run a professional FiveM store. No technical knowledge required.
            </p>
          </div>
            ...
            {platformBenefits.map((benefit, index) => (
              <div key={index} className="relative">
                ...
                <div className="space-y-4">
                  {benefit.benefits.map((point, pointIndex) => (
                    <div key={pointIndex} className="flex items-center gap-4 group hover:scale-105 transition-transform duration-300">
                      ...
                      <span className="text-gray-300 group-hover:text-white transition-colors text-lg">{point}</span>
                    </div>
                  ))}
                </div>
              </div>
