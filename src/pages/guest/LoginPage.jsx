...
const LoginPage = () => {
    ...
    return (
        ...
        >
            <h2 className="text-3xl font-bold text-gray-300 mb-2 text-center">
                Sign In
            </h2>
            <small className="text-gray-500 text-sm mb-8 block text-center">
                Hi, Welcome back 👋
            </small>
            <div className="mb-6">
                <span className="block text-gray-300 mb-2 text-sm">Email</span>
                <div className="flex items-center rounded-md px-3 py-2 box-border border-[1px] border-neutral-200">
                    ...
                    <input
                        className="w-full bg-transparent text-neutral-300 focus:outline-none"
                        type="email"
                        name="email"
                        autoComplete="off"
            ...
            <div className="mb-6">
                <span className="block text-gray-300 mb-2 text-sm">
                    Password
                </span>
                <div className="flex items-center rounded-md px-3 py-2 box-border border-[1px] border-neutral-200">
